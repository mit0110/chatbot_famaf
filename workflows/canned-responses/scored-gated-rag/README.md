...
**score-gated-rag-v2-secure** extiende la versión 2 (presente en [experimentals/](../experimental/)) incorporando validaciones adicionales orientadas a la seguridad y al uso eficiente de recursos:
...
Esta versión está pensada para entornos productivos, donde es importante evitar el consumo innecesario de recursos y asegurar un comportamiento predecible ante inputs no soportados o fallas del agente.
